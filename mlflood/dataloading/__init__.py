...
from dataloading.dataset_max_744 import load_dataset as load_catch_744_max
from dataloading.dataset_max_744 import dataloader_args as dl_args_744_max
...
def get_dataloaders(args, catchment_kwargs):
    ...
    if args.task == "wd_ts" and args.data in ["709", "744"]:
